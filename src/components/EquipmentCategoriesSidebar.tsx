...
import { equipmentCategoryNav } from "@/lib/equipment";

type EquipmentCategoriesSidebarProps = {
  activeSlug?: string;
};

export default function EquipmentCategoriesSidebar({
  activeSlug,
}: EquipmentCategoriesSidebarProps) {
  return (
