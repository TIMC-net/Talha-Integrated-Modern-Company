  ...
  return (
    ...
    >
      ...
      */}
      <div className="relative w-full sm:absolute sm:inset-0">
        <div className="relative aspect-video w-full overflow-hidden sm:absolute sm:inset-0 sm:aspect-auto sm:h-full">
          <video
            ...
            playsInline
            preload="metadata"
            poster="/images/header-contracting.webp"
            aria-hidden
          >
      ...
      <div className="container-site relative z-10 w-full -mt-10 pt-0 pb-10 sm:mt-0 sm:pt-[100px] sm:pb-14 lg:pt-[110px] lg:pb-14 2xl:pt-[120px] 2xl:pb-16">
