      ...
      {underOneRoof.map((item, index) => {
        ...
        return (
          <RevealItem key={item.id}>
            <article className="group relative h-full overflow-hidden border border-white/10 bg-navy-950 p-6 transition-[color,background-color,border-color,box-shadow,transform] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] hover:border-accent md:p-7 [@media(hover:hover)_and_(pointer:fine)]:hover:-translate-y-1 [@media(hover:hover)_and_(pointer:fine)]:hover:shadow-[0_20px_40px_-28px_rgba(255,107,53,0.55)]">
              <span
              ...
              <span className="relative mb-5 flex h-12 w-12 items-center justify-center bg-accent/15 text-accent transition duration-500 group-hover:bg-accent group-hover:text-brand-ink">
