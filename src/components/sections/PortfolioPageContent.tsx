            ...
            <div className="mb-10 flex flex-col items-start justify-between gap-5 md:mb-12 md:flex-row md:items-end">
              <div className="max-w-2xl">
                ...
                <p className="mt-3 text-[15px] text-white/60">
                  Selected project highlights across civil infrastructure,
                  foundations, energy, and equipment support. Browse category
                  listings for ongoing and completed packages.
                </p>
                <p className="mt-3 border border-accent/25 bg-accent/10 px-3 py-2 text-[12px] text-accent">
                  Portfolio entries use placeholder titles and stock images —
                  final project photography pending from TIMC.
                </p>
              </div>
