...
function DesktopNav({
  ...
  return (
    <ul
      ref={listRef}
      className="relative flex items-center gap-0.5 2xl:gap-2"
      onMouseLeave={() => {
    ...
    >
      <span
        aria-hidden
        className={cn(
          "pointer-events-none absolute top-1/2 z-0 h-9 -translate-y-1/2 rounded-full transition-all duration-300 ease-out 2xl:h-10",
        ...
        return (
          ...
          >
            <Link
              ...
              className={cn(
                "relative z-10 flex items-center gap-1 rounded-full px-2 py-2 font-display text-[11px] font-semibold tracking-wide whitespace-nowrap uppercase transition-colors lg:px-2.5 xl:px-3 xl:text-[12px] 2xl:px-5 2xl:text-[14px]",
                active || isOpen
  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        size === "md" ? "h-11 w-11" : "h-10 w-10 2xl:h-11 2xl:w-11",
        onDark
    ...
    <>
      ...
      <div className="flex shrink-0 items-center gap-2 sm:gap-3">
        ...
        <Button
          asChild
          size="sm"
          className="h-10 shrink-0 rounded-full px-3 text-[11px] tracking-wide whitespace-nowrap 2xl:h-12 2xl:px-5 2xl:text-xs"
        >
          <Link
            href="/contact"
            tabIndex={interactive ? undefined : -1}
...
export default function Header() {
  ...
  const capsulePad = collapsed
    ? "justify-between gap-3 pr-2.5 pl-5 sm:gap-4 sm:pr-3 sm:pl-6 lg:pr-2.5 lg:pl-5 2xl:pr-3.5 2xl:pl-7"
    : "justify-between gap-2 px-3 sm:gap-3 sm:px-4 md:px-5 lg:gap-2.5 lg:px-4 xl:px-5 2xl:gap-3 2xl:px-7";
      ...
      <div className="pointer-events-none fixed inset-x-0 top-4 z-50 hidden justify-center sm:top-5 md:top-[22px] lg:top-6 lg:flex">
        <div
          className={cn(
            ...
            MORPH,
            collapsed ? "max-w-[600px]" : "max-w-[min(96vw,1180px)] 2xl:max-w-[1280px]",
          )}
        >
          <DualToneShell
            ...
            base={
              <nav
                ...
                className={cn(
                  ...
                  MORPH,
                  "min-h-[68px] py-3 transition-[padding,gap,box-shadow] sm:min-h-[72px] lg:min-h-[72px] 2xl:min-h-[84px] 2xl:py-3.5",
                  capsulePad,
                )}
              >
                <CapsuleInner
            ...
            overlay={
              <nav
                className={cn(
                  ...
                  "min-h-[68px] py-3 sm:min-h-[72px] lg:min-h-[72px] 2xl:min-h-[84px] 2xl:py-3.5",
                  capsulePad,
                )}
              >
                <CapsuleInner
